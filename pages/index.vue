      ...
      <div class="min-h-screen flex relative lg:static surface-ground">
        ...
        >
          <div class="flex h-full">
            ...
            >
              ...
              >
                <img
                  src="images/blocks/logos/hyper-light.svg"
                  alt="Image"
                  height="30"
                />
              </div>
              ...
              <div class="mt-auto">
                <hr
                  class="mb-3 mx-3 border-top-1 border-none border-indigo-300"
                />
                <a
                  v-ripple
                  class="
            ...
            >
              ...
              >
                <div
                  class="p-3 font-medium text-xl text-900"
                  :class="{ hidden: activeTab1 !== 0 }"
                >
                  Dashboard
                </div>
                <div
                  class="p-3 font-medium text-xl text-900"
                  :class="{ hidden: activeTab1 !== 1 }"
                >
                  Bookmarks
                </div>
                <div
                  class="p-3 font-medium text-xl text-900"
                  :class="{ hidden: activeTab1 !== 2 }"
                >
                  Team
                </div>
                <div
                  class="p-3 font-medium text-xl text-900"
                  :class="{ hidden: activeTab1 !== 3 }"
                >
                  Messages
                </div>
                <div
                  class="p-3 font-medium text-xl text-900"
                  :class="{ hidden: activeTab1 !== 4 }"
                >
                  Calendar
                </div>
                <div
                  class="p-3 font-medium text-xl text-900"
                  :class="{ hidden: activeTab1 !== 5 }"
                >
                  Settings
                </div>
              </div>
        ...
        <div class="min-h-screen flex flex-column relative flex-auto">
          ...
          <div class="p-5 flex flex-column flex-auto">
            <div
              class="
                border-2 border-dashed border-round
                surface-border surface-section
                flex-auto
              "
            ></div>
          </div>
